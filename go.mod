module github.com/hyz-is/arandu-wallet
...
require (
	...
	github.com/arandu-io/hesape/database/connectors/mysql v0.10.0
	github.com/arandu-io/hesape/database/connectors/pgx v0.10.0
